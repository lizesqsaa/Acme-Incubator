...
import acme.features.administrator.notices.AdministratorNoticesRepository;
...
@Service
public class AuthenticatedNoticesCreateService implements AbstractCreateService<Authenticated, Notice> {
